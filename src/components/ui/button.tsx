  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        quest: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-glow",
        success: "bg-gradient-success text-success-foreground hover:scale-105 shadow-card hover:shadow-hover",
        gamified: "bg-gradient-accent text-accent-foreground hover:scale-105 shadow-card hover:shadow-hover",
      },
      size: {
        ...
        icon: "h-10 w-10",
        quest: "h-12 px-6 py-3 text-base font-semibold",
      },
    },
    defaultVariants: {
      variant: "default",
